...
func CodecDecInitVer(ctx []CodecCtx, iface []CodecIface, cfg []CodecDecCfg, flags CodecFlags, ver int) CodecErr {
	...
	cflags, _ := (C.vpx_codec_flags_t)(flags), cgoAllocsUnknown
	cver, _ := (C.int)(ver), cgoAllocsUnknown
	ret := C.vpx_codec_dec_init_ver(cctx, ciface, ccfg, cflags, cver)
...
func CodecPeekStreamInfo(iface []CodecIface, data string, dataSz uint, si []CodecStreamInfo) CodecErr {
	ciface, _ := (*C.vpx_codec_iface_t)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&iface)).Data)), cgoAllocsUnknown
	cdata, _ := unpackPUint8String(data)
	cdataSz, _ := (C.uint)(dataSz), cgoAllocsUnknown
	csi, _ := unpackArgSCodecStreamInfo(si)
	ret := C.vpx_codec_peek_stream_info(ciface, cdata, cdataSz, csi)
...
func CodecGetStreamInfo(ctx []CodecCtx, si []CodecStreamInfo) CodecErr {
	cctx, _ := unpackArgSCodecCtx(ctx)
	csi, _ := unpackArgSCodecStreamInfo(si)
	ret := C.vpx_codec_get_stream_info(cctx, csi)
	packSCodecStreamInfo(si, csi)
	packSCodecCtx(ctx, cctx)
	v := (CodecErr)(ret)
	return v
...
func CodecDecode(ctx []CodecCtx, data string, dataSz uint, userPriv unsafe.Pointer, deadline int) CodecErr {
	cctx, _ := unpackArgSCodecCtx(ctx)
	cdata, _ := unpackPUint8String(data)
	cdataSz, _ := (C.uint)(dataSz), cgoAllocsUnknown
	cuserPriv, _ := (unsafe.Pointer)(unsafe.Pointer(userPriv)), cgoAllocsUnknown
	cdeadline, _ := (C.long)(deadline), cgoAllocsUnknown
	ret := C.vpx_codec_decode(cctx, cdata, cdataSz, cuserPriv, cdeadline)
	packSCodecCtx(ctx, cctx)
	v := (CodecErr)(ret)
	return v
}
...
func CodecGetFrame(ctx []CodecCtx, iter []*CodecIter) *Image {
	cctx, _ := unpackArgSCodecCtx(ctx)
	citer, _ := (*unsafe.Pointer)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&iter)).Data)), cgoAllocsUnknown
	ret := C.vpx_codec_get_frame(cctx, citer)
	packSCodecCtx(ctx, cctx)
	v := NewImageRef(ret)
	return v
}
...
func CodecRegisterPutFrameCb(ctx []CodecCtx, cb CodecPutFrameCbFn, userPriv unsafe.Pointer) CodecErr {
	...
	ccb, _ := cb.PassRef()
	cuserPriv, _ := (unsafe.Pointer)(unsafe.Pointer(userPriv)), cgoAllocsUnknown
	ret := C.vpx_codec_register_put_frame_cb(cctx, ccb, cuserPriv)
	packSCodecCtx(ctx, cctx)
	v := (CodecErr)(ret)
	return v
}
...
func CodecRegisterPutSliceCb(ctx []CodecCtx, cb CodecPutSliceCbFn, userPriv unsafe.Pointer) CodecErr {
	...
	ccb, _ := cb.PassRef()
	cuserPriv, _ := (unsafe.Pointer)(unsafe.Pointer(userPriv)), cgoAllocsUnknown
	ret := C.vpx_codec_register_put_slice_cb(cctx, ccb, cuserPriv)
	packSCodecCtx(ctx, cctx)
	v := (CodecErr)(ret)
	return v
}
...
func CodecSetFrameBufferFunctions(ctx []CodecCtx, cbGet GetFrameBufferCbFn, cbRelease ReleaseFrameBufferCbFn, cbPriv unsafe.Pointer) CodecErr {
	cctx, _ := unpackArgSCodecCtx(ctx)
	ccbGet, _ := cbGet.PassRef()
	ccbRelease, _ := cbRelease.PassRef()
	ccbPriv, _ := (unsafe.Pointer)(unsafe.Pointer(cbPriv)), cgoAllocsUnknown
	ret := C.vpx_codec_set_frame_buffer_functions(cctx, ccbGet, ccbRelease, ccbPriv)
	packSCodecCtx(ctx, cctx)
	v := (CodecErr)(ret)
	return v
}
