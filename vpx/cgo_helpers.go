...
func (x *SvcExtraCfg) PassRef() (*C.vpx_svc_extra_cfg_t, *cgoAllocMap) {
	...
	var cspeed_per_layer_allocs *cgoAllocMap
	ref7a0d6872.speed_per_layer, cspeed_per_layer_allocs = *(*[12]C.int)(unsafe.Pointer(&x.SpeedPerLayer)), cgoAllocsUnknown
	allocs7a0d6872.Borrow(cspeed_per_layer_allocs)
...
func (x *SvcExtraCfg) Deref() {
	...
	x.SpeedPerLayer = *(*[12]int32)(unsafe.Pointer(&x.ref7a0d6872.speed_per_layer))
