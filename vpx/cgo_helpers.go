...
// NewCodecStreamInfoRef initialises a new struct holding the reference to the originaitng C struct.
func NewCodecStreamInfoRef(ref *C.vpx_codec_stream_info_t) *CodecStreamInfo {
	if ref == nil {
		return nil
	}
	...
	obj.ref342546e4 = ref
	// enable this if the reference is unmanaged:
	// runtime.SetFinalizer(obj, func(x *CodecStreamInfo) {
	// 	C.free(unsafe.Pointer(x.ref342546e4))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *CodecStreamInfo) PassRef() (ref *C.vpx_codec_stream_info_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *CodecStreamInfo) PassValue() (value C.vpx_codec_stream_info_t, allocs *cgoAllocMap) {
	if x == nil {
		x = NewCodecStreamInfoRef(nil)
	} else if x.ref342546e4 != nil {
		return *x.ref342546e4, nil
	}
	ref, allocs := x.PassRef()
...
func (x *CodecStreamInfo) Deref() {
	...
	x.Sz = (uint)(x.ref342546e4.sz)
	x.W = (uint)(x.ref342546e4.w)
	x.H = (uint)(x.ref342546e4.h)
	x.IsKf = (uint)(x.ref342546e4.is_kf)
}
...
// NewCodecDecCfgRef initialises a new struct holding the reference to the originaitng C struct.
func NewCodecDecCfgRef(ref *C.vpx_codec_dec_cfg_t) *CodecDecCfg {
	if ref == nil {
		return nil
	}
	obj := new(CodecDecCfg)
	obj.ref7df355ac = ref
	// enable this if the reference is unmanaged:
	// runtime.SetFinalizer(obj, func(x *CodecDecCfg) {
	// 	C.free(unsafe.Pointer(x.ref7df355ac))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *CodecDecCfg) PassRef() (ref *C.vpx_codec_dec_cfg_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *CodecDecCfg) PassValue() (value C.vpx_codec_dec_cfg_t, allocs *cgoAllocMap) {
	if x == nil {
		x = NewCodecDecCfgRef(nil)
	} else if x.ref7df355ac != nil {
		return *x.ref7df355ac, nil
	}
	ref, allocs := x.PassRef()
...
func (x *CodecDecCfg) Deref() {
	...
	x.Threads = (uint)(x.ref7df355ac.threads)
	x.W = (uint)(x.ref7df355ac.w)
	x.H = (uint)(x.ref7df355ac.h)
}
...
func (x CodecPutFrameCbFn) PassRef() (ref C.vpx_codec_put_frame_cb_fn_t, allocs *cgoAllocMap) {
	if codecPutFrameCbFn45458E52Func == nil {
		codecPutFrameCbFn45458E52Func = x
	}
	return (C.vpx_codec_put_frame_cb_fn_t)(C.vpx_codec_put_frame_cb_fn_t_45458e52), nil
}

//export codecPutFrameCbFn45458E52
func codecPutFrameCbFn45458E52(cuserPriv unsafe.Pointer, cimg *C.vpx_image_t) {
	if codecPutFrameCbFn45458E52Func != nil {
		userPriv := (unsafe.Pointer)(unsafe.Pointer(cuserPriv))
		var img []Image
		packSImage(img, cimg)
		codecPutFrameCbFn45458E52Func(userPriv, img)
	}
	panic("callback func has not been set (race?)")
}

var codecPutFrameCbFn45458E52Func CodecPutFrameCbFn

// packSImageRect reads sliced Go data structure out from plain C format.
func packSImageRect(v []ImageRect, ptr0 *C.vpx_image_rect_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.vpx_image_rect_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewImageRectRef(&ptr1)
	}
}

// PassRef returns a reference.
func (x CodecPutSliceCbFn) PassRef() (ref C.vpx_codec_put_slice_cb_fn_t, allocs *cgoAllocMap) {
	if codecPutSliceCbFn449A5268Func == nil {
		codecPutSliceCbFn449A5268Func = x
	}
	return (C.vpx_codec_put_slice_cb_fn_t)(C.vpx_codec_put_slice_cb_fn_t_449a5268), nil
}

//export codecPutSliceCbFn449A5268
func codecPutSliceCbFn449A5268(cuserPriv unsafe.Pointer, cimg *C.vpx_image_t, cvalid *C.vpx_image_rect_t, cupdate *C.vpx_image_rect_t) {
	if codecPutSliceCbFn449A5268Func != nil {
		userPriv := (unsafe.Pointer)(unsafe.Pointer(cuserPriv))
		var img []Image
		packSImage(img, cimg)
		var valid []ImageRect
		packSImageRect(valid, cvalid)
		var update []ImageRect
		packSImageRect(update, cupdate)
		codecPutSliceCbFn449A5268Func(userPriv, img, valid, update)
	}
	panic("callback func has not been set (race?)")
}

var codecPutSliceCbFn449A5268Func CodecPutSliceCbFn
...
// NewCodecFrameBufferRef initialises a new struct holding the reference to the originaitng C struct.
func NewCodecFrameBufferRef(ref *C.vpx_codec_frame_buffer_t) *CodecFrameBuffer {
	if ref == nil {
		return nil
	}
	...
	obj.refd319b8f1 = ref
	// enable this if the reference is unmanaged:
	// runtime.SetFinalizer(obj, func(x *CodecFrameBuffer) {
	// 	C.free(unsafe.Pointer(x.refd319b8f1))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *CodecFrameBuffer) PassRef() (ref *C.vpx_codec_frame_buffer_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *CodecFrameBuffer) PassValue() (value C.vpx_codec_frame_buffer_t, allocs *cgoAllocMap) {
	if x == nil {
		x = NewCodecFrameBufferRef(nil)
	} else if x.refd319b8f1 != nil {
		return *x.refd319b8f1, nil
	}
	ref, allocs := x.PassRef()
...
func (x *CodecFrameBuffer) Deref() {
	...
	hxfa9955c.Data = uintptr(unsafe.Pointer(x.refd319b8f1.data))
...
// packSCodecFrameBuffer reads sliced Go data structure out from plain C format.
func packSCodecFrameBuffer(v []CodecFrameBuffer, ptr0 *C.vpx_codec_frame_buffer_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.vpx_codec_frame_buffer_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecFrameBufferRef(&ptr1)
	}
}

// PassRef returns a reference.
func (x GetFrameBufferCbFn) PassRef() (ref C.vpx_get_frame_buffer_cb_fn_t, allocs *cgoAllocMap) {
	if getFrameBufferCbFnC9F1C700Func == nil {
		getFrameBufferCbFnC9F1C700Func = x
	}
	return (C.vpx_get_frame_buffer_cb_fn_t)(C.vpx_get_frame_buffer_cb_fn_t_c9f1c700), nil
}

//export getFrameBufferCbFnC9F1C700
func getFrameBufferCbFnC9F1C700(cpriv unsafe.Pointer, cminSize C.size_t, cfb *C.vpx_codec_frame_buffer_t) C.int {
	if getFrameBufferCbFnC9F1C700Func != nil {
		priv := (unsafe.Pointer)(unsafe.Pointer(cpriv))
		minSize := (uint)(cminSize)
		var fb []CodecFrameBuffer
		packSCodecFrameBuffer(fb, cfb)
		retc9f1c700 := getFrameBufferCbFnC9F1C700Func(priv, minSize, fb)
		ret, _ := (C.int)(retc9f1c700), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}

var getFrameBufferCbFnC9F1C700Func GetFrameBufferCbFn

// PassRef returns a reference.
func (x ReleaseFrameBufferCbFn) PassRef() (ref C.vpx_release_frame_buffer_cb_fn_t, allocs *cgoAllocMap) {
	if releaseFrameBufferCbFn868BB8FCFunc == nil {
		releaseFrameBufferCbFn868BB8FCFunc = x
	}
	return (C.vpx_release_frame_buffer_cb_fn_t)(C.vpx_release_frame_buffer_cb_fn_t_868bb8fc), nil
}

//export releaseFrameBufferCbFn868BB8FC
func releaseFrameBufferCbFn868BB8FC(cpriv unsafe.Pointer, cfb *C.vpx_codec_frame_buffer_t) C.int {
	if releaseFrameBufferCbFn868BB8FCFunc != nil {
		priv := (unsafe.Pointer)(unsafe.Pointer(cpriv))
		var fb []CodecFrameBuffer
		packSCodecFrameBuffer(fb, cfb)
		ret868bb8fc := releaseFrameBufferCbFn868BB8FCFunc(priv, fb)
		ret, _ := (C.int)(ret868bb8fc), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}

var releaseFrameBufferCbFn868BB8FCFunc ReleaseFrameBufferCbFn
...
// unpackArgSCodecDecCfg transforms a sliced Go data structure into plain C format.
func unpackArgSCodecDecCfg(x []CodecDecCfg) (unpacked *C.vpx_codec_dec_cfg_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.vpx_codec_dec_cfg_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocCodecDecCfgMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]C.vpx_codec_dec_cfg_t)(unsafe.Pointer(h0))
	for i0 := range x {
		v0[i0], _ = x[i0].PassValue()
	}
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.vpx_codec_dec_cfg_t)(unsafe.Pointer(h.Data))
	return
}

// packSCodecDecCfg reads sliced Go data structure out from plain C format.
func packSCodecDecCfg(v []CodecDecCfg, ptr0 *C.vpx_codec_dec_cfg_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.vpx_codec_dec_cfg_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecDecCfgRef(&ptr1)
	}
}
...
// unpackArgSCodecStreamInfo transforms a sliced Go data structure into plain C format.
func unpackArgSCodecStreamInfo(x []CodecStreamInfo) (unpacked *C.vpx_codec_stream_info_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.vpx_codec_stream_info_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocCodecStreamInfoMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]C.vpx_codec_stream_info_t)(unsafe.Pointer(h0))
	for i0 := range x {
		v0[i0], _ = x[i0].PassValue()
	}
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.vpx_codec_stream_info_t)(unsafe.Pointer(h.Data))
	return
}

// packSCodecStreamInfo reads sliced Go data structure out from plain C format.
func packSCodecStreamInfo(v []CodecStreamInfo, ptr0 *C.vpx_codec_stream_info_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.vpx_codec_stream_info_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecStreamInfoRef(&ptr1)
	}
}
