...
// WARNING: This file has automatically been generated on Thu, 22 Sep 2016 02:08:13 MSK.
...
func packSCodecCxPkt(v []CodecCxPkt, ptr0 *C.vpx_codec_cx_pkt_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfCodecCxPktValue]C.vpx_codec_cx_pkt_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecCxPktRef(unsafe.Pointer(&ptr1))
	}
}
...
func codecEncOutputCxPktCbFn947769C1(cpkt *C.vpx_codec_cx_pkt_t, cuserData unsafe.Pointer) {
	if codecEncOutputCxPktCbFn947769C1Func != nil {
		var pkt947769c1 []CodecCxPkt
		packSCodecCxPkt(pkt947769c1, cpkt)
...
// NewSvcExtraCfgRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewSvcExtraCfgRef(ref unsafe.Pointer) *SvcExtraCfg {
	...
	obj := new(SvcExtraCfg)
	obj.ref7a0d6872 = (*C.vpx_svc_extra_cfg_t)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *SvcExtraCfg) PassRef() (*C.vpx_svc_extra_cfg_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x SvcExtraCfg) PassValue() (C.vpx_svc_extra_cfg_t, *cgoAllocMap) {
...
func (x *SvcExtraCfg) Deref() {
	...
	x.MaxQuantizers = *(*[12]int32)(unsafe.Pointer(&x.ref7a0d6872.max_quantizers))
	x.MinQuantizers = *(*[12]int32)(unsafe.Pointer(&x.ref7a0d6872.min_quantizers))
	x.ScalingFactorNum = *(*[12]int32)(unsafe.Pointer(&x.ref7a0d6872.scaling_factor_num))
	x.ScalingFactorDen = *(*[12]int32)(unsafe.Pointer(&x.ref7a0d6872.scaling_factor_den))
	x.TemporalLayeringMode = (int32)(x.ref7a0d6872.temporal_layering_mode)
}
...
func NewCodecIfaceRef(ref *C.vpx_codec_iface_t) *CodecIface {
	return (*CodecIface)(unsafe.Pointer(ref))
}
...
func NewCodecPrivRef(ref *C.vpx_codec_priv_t) *CodecPriv {
	return (*CodecPriv)(unsafe.Pointer(ref))
}
...
// NewCodecCtxRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewCodecCtxRef(ref unsafe.Pointer) *CodecCtx {
	...
	obj := new(CodecCtx)
	obj.ref8abc1e81 = (*C.vpx_codec_ctx_t)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *CodecCtx) PassRef() (*C.vpx_codec_ctx_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x CodecCtx) PassValue() (C.vpx_codec_ctx_t, *cgoAllocMap) {
...
func (x *Image) Deref() {
	...
	hxff2234b := (*sliceHeader)(unsafe.Pointer(&x.ImgData))
	hxff2234b.Data = uintptr(unsafe.Pointer(x.refc09455e3.img_data))
...
func packSImage(v []Image, ptr0 *C.vpx_image_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfImageValue]C.vpx_image_t)(unsafe.Pointer(ptr0)))[i0]
...
func codecPutFrameCbFnF425E4FC(cuserPriv unsafe.Pointer, cimg *C.vpx_image_t) {
	if codecPutFrameCbFnF425E4FCFunc != nil {
		...
		var imgf425e4fc []Image
		packSImage(imgf425e4fc, cimg)
...
func packSImageRect(v []ImageRect, ptr0 *C.vpx_image_rect_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfImageRectValue]C.vpx_image_rect_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewImageRectRef(unsafe.Pointer(&ptr1))
	}
}
...
func codecPutSliceCbFn1C2E1E21(cuserPriv unsafe.Pointer, cimg *C.vpx_image_t, cvalid *C.vpx_image_rect_t, cupdate *C.vpx_image_rect_t) {
	if codecPutSliceCbFn1C2E1E21Func != nil {
		...
		var img1c2e1e21 []Image
		packSImage(img1c2e1e21, cimg)
		var valid1c2e1e21 []ImageRect
		packSImageRect(valid1c2e1e21, cvalid)
		var update1c2e1e21 []ImageRect
		packSImageRect(update1c2e1e21, cupdate)
...
func (x *CodecFrameBuffer) Deref() {
	...
	hxff73280.Data = uintptr(unsafe.Pointer(x.refd319b8f1.data))
...
func packSCodecFrameBuffer(v []CodecFrameBuffer, ptr0 *C.vpx_codec_frame_buffer_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfCodecFrameBufferValue]C.vpx_codec_frame_buffer_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecFrameBufferRef(unsafe.Pointer(&ptr1))
	}
}
...
func getFrameBufferCbFnF5FE44EB(cpriv unsafe.Pointer, cminSize C.size_t, cfb *C.vpx_codec_frame_buffer_t) C.int {
	if getFrameBufferCbFnF5FE44EBFunc != nil {
		...
		var fbf5fe44eb []CodecFrameBuffer
		packSCodecFrameBuffer(fbf5fe44eb, cfb)
...
func releaseFrameBufferCbFnED49B503(cpriv unsafe.Pointer, cfb *C.vpx_codec_frame_buffer_t) C.int {
	if releaseFrameBufferCbFnED49B503Func != nil {
		...
		var fbed49b503 []CodecFrameBuffer
		packSCodecFrameBuffer(fbed49b503, cfb)
...
func packSCodecCtx(v []CodecCtx, ptr0 *C.vpx_codec_ctx_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfCodecCtxValue]C.vpx_codec_ctx_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecCtxRef(unsafe.Pointer(&ptr1))
	}
}
...
func packSCodecEncCfg(v []CodecEncCfg, ptr0 *C.vpx_codec_enc_cfg_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfCodecEncCfgValue]C.vpx_codec_enc_cfg_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecEncCfgRef(unsafe.Pointer(&ptr1))
	}
}
...
func packSRational(v []Rational, ptr0 *C.vpx_rational_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfRationalValue]C.vpx_rational_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewRationalRef(unsafe.Pointer(&ptr1))
	}
}
...
func packSFixedBuf(v []FixedBuf, ptr0 *C.vpx_fixed_buf_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfFixedBufValue]C.vpx_fixed_buf_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewFixedBufRef(unsafe.Pointer(&ptr1))
	}
}
...
func packSCodecDecCfg(v []CodecDecCfg, ptr0 *C.vpx_codec_dec_cfg_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfCodecDecCfgValue]C.vpx_codec_dec_cfg_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecDecCfgRef(unsafe.Pointer(&ptr1))
	}
}
...
func packSCodecStreamInfo(v []CodecStreamInfo, ptr0 *C.vpx_codec_stream_info_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfCodecStreamInfoValue]C.vpx_codec_stream_info_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewCodecStreamInfoRef(unsafe.Pointer(&ptr1))
	}
}
