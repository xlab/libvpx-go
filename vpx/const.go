...
const (
	// Vp8Fourcc as defined in libvpx-go/<predefine>:21
	Vp8Fourcc = 808996950
	// Vp9Fourcc as defined in libvpx-go/<predefine>:22
	Vp9Fourcc = 809062486
	...
	CodecUsePsnr = 65536
	// CodecUseOutputPartition as defined in vpx-1.6.0/vpx_encoder.h:99
	CodecUseOutputPartition = 131072
	// CodecUseHighbitdepth as defined in vpx-1.6.0/vpx_encoder.h:100
	CodecUseHighbitdepth = 262144
	// FrameIsKey as defined in vpx-1.6.0/vpx_encoder.h:126
	FrameIsKey = 1
	// FrameIsDroppable as defined in vpx-1.6.0/vpx_encoder.h:129
	FrameIsDroppable = 2
	// FrameIsInvisible as defined in vpx-1.6.0/vpx_encoder.h:131
	FrameIsInvisible = 4
	// FrameIsFragment as defined in vpx-1.6.0/vpx_encoder.h:133
	FrameIsFragment = 8
	// ErrorResilientDefault as defined in vpx-1.6.0/vpx_encoder.h:143
	ErrorResilientDefault = 1
	// ErrorResilientPartitions as defined in vpx-1.6.0/vpx_encoder.h:148
	ErrorResilientPartitions = 2
	// EflagForceKf as defined in vpx-1.6.0/vpx_encoder.h:277
	EflagForceKf = 1
	// DlRealtime as defined in vpx-1.6.0/vpx_encoder.h:842
	DlRealtime = 1
	// DlGoodQuality as defined in vpx-1.6.0/vpx_encoder.h:844
	DlGoodQuality = 1000000
	// DlBestQuality as defined in vpx-1.6.0/vpx_encoder.h:846
	DlBestQuality = 0
	// CodecABIVersion as defined in vpx-1.6.0/vpx_codec.h:86
	CodecABIVersion = 7
	// CodecCapDecoder as defined in vpx-1.6.0/vpx_codec.h:152
	CodecCapDecoder = 1
	// CodecCapEncoder as defined in vpx-1.6.0/vpx_codec.h:153
	CodecCapEncoder = 2
	// ForceInline as defined in vpx-1.6.0/vpx_integer.h:21
	ForceInline = 0
	// Inline as defined in vpx-1.6.0/vpx_integer.h:23
	Inline = 0
	// ImageABIVersion as defined in vpx-1.6.0/vpx_image.h:30
	ImageABIVersion = 4
	// ImageFormatPlanar as defined in vpx-1.6.0/vpx_image.h:32
	ImageFormatPlanar = 256
	// ImageFormatUvFlip as defined in vpx-1.6.0/vpx_image.h:33
	ImageFormatUvFlip = 512
	// ImageFormatHasAlpha as defined in vpx-1.6.0/vpx_image.h:34
	ImageFormatHasAlpha = 1024
	// ImageFormatHighbitdepth as defined in vpx-1.6.0/vpx_image.h:35
	...
	// CodecCapPutSlice as defined in vpx-1.6.0/vpx_decoder.h:54
	CodecCapPutSlice = 65536
	// CodecCapPutFrame as defined in vpx-1.6.0/vpx_decoder.h:55
	CodecCapPutFrame = 131072
	// CodecCapPostproc as defined in vpx-1.6.0/vpx_decoder.h:56
	CodecCapPostproc = 262144
	// CodecCapErrorConcealment as defined in vpx-1.6.0/vpx_decoder.h:58
	CodecCapErrorConcealment = 524288
	// CodecCapInputFragments as defined in vpx-1.6.0/vpx_decoder.h:60
	CodecCapInputFragments = 1048576
	// CodecCapFrameThreading as defined in vpx-1.6.0/vpx_decoder.h:70
	CodecCapFrameThreading = 2097152
	// CodecCapExternalFrameBuffer as defined in vpx-1.6.0/vpx_decoder.h:72
	CodecCapExternalFrameBuffer = 4194304
	// CodecUsePostproc as defined in vpx-1.6.0/vpx_decoder.h:74
	CodecUsePostproc = 65536
	// CodecUseErrorConcealment as defined in vpx-1.6.0/vpx_decoder.h:76
	CodecUseErrorConcealment = 131072
	// CodecUseInputFragments as defined in vpx-1.6.0/vpx_decoder.h:79
	CodecUseInputFragments = 262144
	// CodecUseFrameThreading as defined in vpx-1.6.0/vpx_decoder.h:81
...
// CodecCxPktKind as declared in vpx-1.6.0/vpx_encoder.h:156
type CodecCxPktKind int32

// CodecCxPktKind enumeration from vpx-1.6.0/vpx_encoder.h:156
const (
...
// EncPass as declared in vpx-1.6.0/vpx_encoder.h:241
type EncPass int32

// EncPass enumeration from vpx-1.6.0/vpx_encoder.h:241
const (
...
// RcMode as declared in vpx-1.6.0/vpx_encoder.h:248
type RcMode int32

// RcMode enumeration from vpx-1.6.0/vpx_encoder.h:248
const (
	Vbr = C.VPX_VBR
	Cbr = C.VPX_CBR
	Cq  = C.VPX_CQ
...
// KfMode as declared in vpx-1.6.0/vpx_encoder.h:263
type KfMode int32

// KfMode enumeration from vpx-1.6.0/vpx_encoder.h:263
const (
...
// BitDepth as declared in vpx-1.6.0/vpx_codec.h:216
type BitDepth int32

// BitDepth enumeration from vpx-1.6.0/vpx_codec.h:216
const (
...
// CodecErr as declared in vpx-1.6.0/vpx_codec.h:141
type CodecErr int32

// CodecErr enumeration from vpx-1.6.0/vpx_codec.h:141
const (
